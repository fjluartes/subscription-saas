import { FaChartLine, FaBell, FaMoneyBillWave, FaMobile, FaShieldAlt, FaCheck } from 'react-icons/fa'
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <Link to="/" className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-xl font-bold text-gray-900">SubTrack</span>
              </Link>
            </div>
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Track, manage, and optimize all your subscriptions in one place. Never pay for unused services again.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 space-y-8 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-8">
            {pricingPlans.map((plan) => (
              <div key={plan.name} className={`relative p-6 rounded-lg shadow-md ${plan.featured ? 'bg-white ring-2 ring-blue-500' : 'bg-white'}`}>
                {plan.featured && (
      ...
      <div className="bg-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            ...
            <span className="block text-blue-600">Start tracking your subscriptions today.</span>
          </h2>
...
const features = [
  {
    ...
    description: 'View all your subscriptions in one dashboard with clear spending insights.',
    icon: FaChartLine,
  },
  {
    name: 'Renewal Alerts',
    description: 'Get notified before subscriptions renew so you can cancel unwanted services.',
    icon: FaBell,
  },
  {
    name: 'Cost Analysis',
    description: 'See monthly and yearly spending breakdowns to identify savings opportunities.',
    icon: FaMoneyBillWave,
  },
  {
    name: 'Mobile Friendly',
    description: 'Access your subscription data anywhere with our responsive design.',
    icon: FaMobile,
  },
  {
    name: 'Secure Data',
